...
# This file was created by PuppetAgent for Solaris 11 i386.  Any
...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.5.0/i386-solaris2.11")
  ...
  CONFIG["MAKEDIRS"] = "/usr/ccs/bin/gmkdir -p"
  CONFIG["MKDIR_P"] = "/usr/ccs/bin/gmkdir -p"
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["EGREP"] = "/usr/ccs/bin/ggrep -E"
  CONFIG["GREP"] = "/usr/ccs/bin/ggrep"
  CONFIG["CPP"] = "$(CC) -E"
  ...
  CONFIG["RUBY_RELEASE_DATE"] = "2018-03-28"
  CONFIG["RUBY_PROGRAM_VERSION"] = "2.5.1"
  CONFIG["target_alias"] = ""
  CONFIG["host_alias"] = ""
  CONFIG["build_alias"] = ""
  CONFIG["LIBS"] = "-lpthread -lsocket -ldl -lcrypt -lm "
  CONFIG["ECHO_T"] = ""
  CONFIG["ECHO_N"] = ""
  CONFIG["ECHO_C"] = "\\\\c"
