...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.4.0/sparc-solaris2.11")
  ...
  CONFIG["MAKEDIRS"] = "/usr/bin/gmkdir -p"
  CONFIG["MKDIR_P"] = "/usr/bin/gmkdir -p"
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["EGREP"] = "/usr/bin/ggrep -E"
  CONFIG["GREP"] = "/usr/bin/ggrep"
  CONFIG["CPP"] = "$(CC) -E"
