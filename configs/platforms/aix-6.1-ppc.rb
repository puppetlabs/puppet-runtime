platform "aix-6.1-ppc" do |plat|
  ...
  plat.provision_with "yum install -y pl-gcc pl-cmake coreutils autoconf gawk-3.1.3-1 pkg-config-0.19-6 rsync sed make tar glib2 perl zlib-1.2.3-4 zlib-devel-1.2.3-4"
